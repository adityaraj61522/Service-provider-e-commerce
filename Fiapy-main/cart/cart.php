...
<section class="showcase">
  <div class="container">
    <div class="pb-2 mt-4 mb-2 border-bottom">
      <h2>Build Simple Shopping Cart using PHP <a style="float: right;" href="#" class="btn btn-primary text-right">  Cart <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="badge badge-light" id="cart-count"><?php print $count; ?></span></a></h2>
...
<button type="button" class="btn btn-success" id="checkout"><a href="/Fiapy-main/summary.php"> CheckOu </a></button>
				</div>
			</div>
</section>
