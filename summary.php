...
<div id="content" class="row">
	...
	$array = json_decode($_COOKIE['products']);
	...
	// $sql = " INSERT INTO `summary` (`sno`, `houseno`, `streetno`, `po`, `dist`, `state`, `pin`, `landmark`, `firstname`, `lastname`, `phoneno`, `email`, `servicetype`, `orderitems`) VALUES (NULL, '', '', '', '', '', '', '', '', '', '', '', '', ' $array '); ";
		...
		<div>
			<table style="width:300px">
				...
				<tr>
					...
					<td></td>
					<td><i class="fa fa-rupee"></i> <?php echo $totalCost; ?></td>
				</tr>
			</table>
		</div>
		<div>
